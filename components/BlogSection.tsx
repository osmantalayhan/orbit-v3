      ...
      >
        <header className="w-full relative flex flex-col md:flex-row items-start md:items-end justify-start md:justify-between" style={{ marginBottom: '40px' }}>
          ...
          <motion.div 
            ...
            className="mobile-button-group md:mt-0 flex flex-col md:flex-row w-full md:w-auto justify-start md:justify-end md:gap-4"
          >
            <Link 
              href="/blog" 
          ...
          <div className="flex" style={{ marginLeft: '-32px' }}>
            {blogs.map((blog, index) => (
              <motion.div
                ...
                className="flex-[0_0_100%] md:flex-[0_0_calc(100%/3)] min-w-0"
