...
function ScrollItem({ item, setActiveId, isActive }: { item: typeof content[0], setActiveId: (id: string) => void, isActive: boolean }) {
  ...
  return (
    <div ref={ref} className="flex items-center justify-center">
      <div 
        className="w-full h-[400px] md:h-[550px] bg-[#0d0d0d] border border-white/10 rounded-[32px] overflow-hidden relative group transition-all duration-700"
        style={{ 
  ...
  return (
    ...
    >
      <div className="max-w-[1304px] w-full px-12 md:px-6 grid grid-cols-1 md:grid-cols-2 gap-20">
        ...
        <div className="h-fit sticky top-48 flex flex-col items-start">
          <div 
